class DocumentationDisplay
{
    ...
    Run()
    {
        ...
        _g.fillRect(this.barBox.x, this.barBox.y, this.barBox.w, this.barBox.h);

        if ( !UserIsGrabbing )
        {
            if ( mousepressed && IsMouseInsideBox(this.barBox, this.Canvas))
            {
    ...
    Close()
    {
        ...
        this.Opened = false;
        this.Canvas.ForceFill("rgb(0,0,0)");
